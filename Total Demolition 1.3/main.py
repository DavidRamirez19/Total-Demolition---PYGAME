...
def menuPrincipal():
	...
	ventana = pygame.display.set_mode((250,200))#Crear una ventana de tamanio
        #Menu Principal
	pygame.display.set_caption("TOTAL DEMOLITION")
	menu=Menu('Menu Principal')
	opciones=['1.Iniciar','2. Opciones','3. Salir']
...
def menuPausa():
	reloj = pygame.time.Clock()
	ventana = pygame.display.set_mode((200,200)) #crear una ventana de un tamanio
        #Menu Principal
	pygame.display.set_caption("TOTAL DEMOLITION")
	menu=Menu('Menu Pausa')
	opciones=['1.Continuar','2. Opciones','3. Salir']
	menu.opciones=opciones
	fin=False
...
def totalDemolition(puntuacion,mapa):
    ...
    menuPrincipal() # Crea un menu principal
